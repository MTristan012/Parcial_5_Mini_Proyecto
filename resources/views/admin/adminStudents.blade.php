                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('userStudents.update')}}" method="POST">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="InputEmail" class="form-label">DNI</label>
                                                                <input name="adminStudentDNI" type="text"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="InputEmail" class="form-label">Email</label>
                                                                <input name="adminStudentEmail" type="email"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="InputName" class="form-label">Name</label>
                                                                <input name="adminStudentName" type="name"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="adminStudentAddress" type="text"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="adminStudentBirthday" type="date"
